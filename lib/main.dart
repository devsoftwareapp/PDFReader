...
import 'package:pdf_reader_manager/tools.dart'; // ToolsScreen için import
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              children: [
              Text('PDF Reader v2.1.0.1', style: TextStyle(fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
              Text('Gelişmiş PDF görüntüleme ve Düzenleme uygulaması'),
              SizedBox(height: 16),
        SizedBox(height: 16),
              Text('Lisans Bilgileri:', style: TextStyle(fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
              Text('Bu uygulama Dev Software tarafından kullanıcı gizliliği ve güvenliği gözetilerek geliştirilmiştir. Her hakkı saklıdır.'),
              SizedBox(height: 8),
