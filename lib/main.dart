...
class AppLocalizations {
  static Map<String, Map<String, String>> _localizedValues = {
    ...
    'bn': {
      ...
      'delete_message': 'আপনি কি নিশ্চিত যে আপনি ফাইলটি মুছতে চান? এই ক্রিয়াটি পূর্বাবস্থায় ফেরানো যাবে না।',
  ...
  static String of(String key, BuildContext context) {
    final languageManager = context.findAncestorWidgetOfExactType<_HomePageState>()?.widget?.languageManager;
    final currentLang = languageManager?.currentLanguage ?? 'en';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  final List<String> _tabTitles = [
    AppLocalizations.of('home', context),
    AppLocalizations.of('tools', context),
    AppLocalizations.of('files', context)
  ];
  
  final List<String> _homeTabTitles = [
    AppLocalizations.of('device_files', context),
    AppLocalizations.of('recent', context),
    AppLocalizations.of('favorites', context)
  ];
  ...
  void _showPermissionDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          AppLocalizations.of('permission_title', context),
          style: TextStyle(color: Color(0xFFD32F2F))
        ),
        content: Text(AppLocalizations.of('permission_message', context)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(AppLocalizations.of('cancel', context)),
          ),
          ElevatedButton(
            ...
            child: Text(AppLocalizations.of('grant_permission', context), style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
  ...
  Future<void> _deleteFile(String filePath) async {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of('delete_title', context)),
        content: Text('"$fileName" ${AppLocalizations.of('delete_message', context)}'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(AppLocalizations.of('cancel', context)),
          ...
          ElevatedButton(
            ...
            child: Text(AppLocalizations.of('confirm_delete', context), style: TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              AppLocalizations.of('permission_message', context),
            ...
            ElevatedButton(
              ...
              child: Text(AppLocalizations.of('grant_permission', context)),
            ),
          ],
        ),
      ),
        ...
        children: [
          ...
          Text(
            _isSearchMode && _searchController.text.isNotEmpty 
                ? AppLocalizations.of('search_history', context)
                : AppLocalizations.of('no_files', context),
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: Color(0xFFD32F2F)),
            child: Text(AppLocalizations.of('scan_again', context), style: TextStyle(color: Colors.white)),
          ),
          SizedBox(height: 8),
          TextButton(
            onPressed: _pickPdfFile,
            child: Text(AppLocalizations.of('pick_file', context), style: TextStyle(color: Color(0xFFD32F2F))),
          ),
        ],
      ),
    );
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(
                    AppLocalizations.of('clear', context),
                    style: TextStyle(color: Colors.grey)
                  ),
                ),
              ],
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) => [
                PopupMenuItem(value: 'share', child: Text(AppLocalizations.of('share', context))),
                PopupMenuItem(value: 'rename', child: Text(AppLocalizations.of('rename', context))),
                PopupMenuItem(value: 'print', child: Text(AppLocalizations.of('print', context))),
                PopupMenuItem(value: 'delete', child: Text(AppLocalizations.of('delete', context), style: TextStyle(color: Colors.red))),
              ],
            ),
          ],
        ),
  ...
  void _showRenameDialog(String filePath) {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of('rename', context)),
        content: TextField(
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              AppLocalizations.of('no_recent', context),
              style: TextStyle(fontSize: 18, color: Colors.grey),
            ),
            SizedBox(height: 8),
            Text(
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              AppLocalizations.of('no_favorites', context),
              style: TextStyle(fontSize: 18, color: Colors.grey),
            ),
            SizedBox(height: 8),
            Text(
    ...
    return ListView(
      children: [
        ...
        Padding(
          ...
          child: Text(
            AppLocalizations.of('cloud_storage', context),
        ...
        Padding(
          ...
          child: Text(
            AppLocalizations.of('email_integration', context),
            style: TextStyle(fontSize: 16, color: Colors.grey, fontWeight: FontWeight.w500)
          ),
        ),
        _buildGmailItem(),
        ...
        Padding(
          ...
          child: _buildCloudItem(
            AppLocalizations.of('more_files', context),
            Icons.folder_open,
            true,
            _pickPdfFile
          ),
      ...
      children: [
        if (_isFabOpen) ...[
          Positioned(
            ...
            child: Column(
              children: [
                _buildSubFabItem(AppLocalizations.of('pick_file', context), Icons.attach_file, _pickPdfFile),
                SizedBox(height: 12),
                _buildSubFabItem(AppLocalizations.of('scan', context), Icons.document_scanner, () => _showComingSoon('Tarama')),
                SizedBox(height: 12),
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(Icons.info, AppLocalizations.of('about', context), _showAboutDialog),
          _buildDrawerItem(Icons.help, AppLocalizations.of('help', context), _showHelpSupport),
          Divider(),
          _buildDrawerSubItem(AppLocalizations.of('app_language', context), _showAppLanguageDialog),
          _buildDrawerSubItem(AppLocalizations.of('privacy', context), _showPrivacyPolicy),
        ],
      ),
    );
  }
  ...
  void _showAppLanguageDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          AppLocalizations.of('app_language', context),
          style: TextStyle(color: Color(0xFFD32F2F))
        ),
        content: Container(
        ...
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(
              AppLocalizations.of('close', context),
              style: TextStyle(color: Color(0xFFD32F2F))
            ),
          ),
        ],
  ...
  void _showHelpSupport() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          AppLocalizations.of('help', context),
          style: TextStyle(color: Color(0xFFD32F2F))
        ),
  ...
  void _showPrivacyPolicy() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          AppLocalizations.of('privacy_policy', context),
          style: TextStyle(color: Color(0xFFD32F2F))
        ),
        content: SingleChildScrollView(
          child: Column(
  ...
  void _showAboutDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          AppLocalizations.of('about', context),
          style: TextStyle(color: Color(0xFFD32F2F))
        ),
        content: SingleChildScrollView(
          child: Column(
  ...
  PreferredSizeWidget _buildSearchAppBar() {
    return AppBar(
      ...
      title: TextField(
        ...
        decoration: InputDecoration(
          hintText: AppLocalizations.of('search_hint', context),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              ...
              label: AppLocalizations.of('home', context),
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.build),
              label: AppLocalizations.of('tools', context),
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.folder),
              label: AppLocalizations.of('files', context),
            ),
          ],
        ),
      ),
...
class _ViewerScreenState extends State<ViewerScreen> {
  ...
  Future<void> _saveEditedPdfToDownloads(String filename, String base64Data) async {
    try {
      ...
      // "update_" prefix ile yeni dosya adı oluştur - GÜNCELLENDİ
      String baseName = p.basenameWithoutExtension(filename);
      
      // Eğer dosya adı zaten "update_" ile başlıyorsa, onu kaldır
      if (baseName.toLowerCase().startsWith('update_')) {
        baseName = baseName.substring(7); // "update_" kısmını kaldır (7 karakter)
      }
              ...
              children: [
                InAppWebView(
                  ...
                  onWebViewCreated: (controller) {
                    ...
                    // Dil değişikliklerini WebView'a iletiyoruz
                    widget.languageManager.addListener(() {
